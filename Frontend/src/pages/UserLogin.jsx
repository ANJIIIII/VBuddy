            ...
            <div className="text-center max-w-lg">
              ...
              <div className="space-y-2 md:space-y-3 lg:space-y-4 text-left">
                <div className="flex items-center space-x-2 md:space-x-3">
                  ...
                  <span style={{ color: "#DFD0B8" }} className="text-sm md:text-base">Manage appointments</span>
                </div>
                <div className="flex items-center space-x-2 md:space-x-3">
                  <div 
                    className="w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center flex-shrink-0"
                  ...
                  <span style={{ color: "#DFD0B8" }} className="text-sm md:text-base">Track pet services</span>
                </div>
                <div className="flex items-center space-x-2 md:space-x-3">
                  <div 
                    className="w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center flex-shrink-0"
                  ...
                  <span style={{ color: "#DFD0B8" }} className="text-sm md:text-base">Manage payments</span>
                </div>
                <div className="flex items-center space-x-2 md:space-x-3">
                  <div 
                    className="w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center flex-shrink-0"
                  ...
                  <span style={{ color: "#DFD0B8" }} className="text-sm md:text-base">Access digital services</span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    {roleOptions.map((option) => (
                      <label
                        ...
                        style={{
                          borderColor: formData.role === option.value ? "#948979" : "#e5e7eb",
                          backgroundColor: formData.role === option.value ? "#DFD0B8" : "transparent",
                          color: formData.role === option.value ? "#222831" : "#374151"
                        }}
                        onMouseEnter={(e) => {
                          if (formData.role !== option.value) {
                            e.currentTarget.style.borderColor = "#948979";
                            e.currentTarget.style.backgroundColor = "rgba(223, 208, 184, 0.3)";
                          }
                        }}
                        onMouseLeave={(e) => {
                          if (formData.role !== option.value) {
                ...
                <button
                  ...
                  style={{
                    backgroundColor: !formData.role || !formData.email || !formData.password ? "#9ca3af" : "#222831"
                  }}
                  onMouseEnter={(e) => {
